...
<div class="content-right">
	...
	<div class="content-text">
		<form action="${path }/tranOrder_taskList?query.orderType=1&query.orderState=2" method="post"> 
			...
			<div class="square-order">
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<tr align="center" bgcolor="#FFFFFF">
							...
							<td><s:date name="#order.createTime" format="yyyy-MM-dd"/></td>
							<td><s:property value="#order.orderCreater.name"/></td>
							<td><s:date name="#order.checkTime" format="yyyy-MM-dd"/></td>
