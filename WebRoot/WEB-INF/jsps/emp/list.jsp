...
<script type="text/javascript">
	...
	function grantRole(empId, roleIds){
		var result = "";
		//将数据发出到ajax_emp_grantrole函数中进行处理
		$.ajax({
			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="70"><a id="addEmpButton" href="#"> <img src="${path }/images/can_b_02.gif" border="0" /> </a></td>
					</tr>
					<tr>
					...
					<s:iterator value="#page.list" var="emp">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td>
								...
								<img src="${path }/images/icon_3.gif" /> 
								<span style="line-height:12px; text-align:center;"> 
									<a href="#" class="xiu" onclick="updateEmp(<s:property value="#emp.empId"/>)">修改</a>
								</span> 
								<img src="${path }/images/icon_04.gif" /> 
								<span style="line-height:12px; text-align:center;"> 
									<a href="#" class="xiu" onclick="deleteEmp(<s:property value="#emp.empId"/>)">删除</a>
								</span>
							</td>
						</tr>
					</s:iterator>
