			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>提货方式：</td>
						<td>
							<s:select list="#{'1':'自提','2':'送货'}" name="query.needs" cssClass="kuan" headerKey="" headerValue="----请-选-择----"></s:select>
						</td>
						<td>
							<a id="addSupplierButton" href="#"><img src="${path }/images/can_b_02.gif" border="0" /> </a></td>
					</tr>
				</table>
			</div>
			<!--"square-o-top"end-->
			<div class="square-order">
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<tr align="center" bgcolor="#FFFFFF">
						...
						<td><s:property value="#supplier.needs==1?'自提':'送货'"/> </td>
						<td>
							<img src="${path }/images/icon_3.gif" /> 
							<span style="line-height:12px; text-align:center;"> 
								<a href="#" class="xiu" onclick="updateSupplier(<s:property value="#supplier.supplierId"/>)">修改</a>
							</span> 
							<img src="${path }/images/icon_04.gif" /> 
							<span style="line-height:12px; text-align:center;"> 
								<a href="#" class="xiu" onclick="deleteSupplier(<s:property value="#supplier.supplierId"/>)">删除</a>
							</span>
						</td>
					</tr>
					</s:iterator>
