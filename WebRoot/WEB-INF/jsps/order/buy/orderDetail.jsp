			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>下单时间:</td>
						<td class="order_show_msg"><s:date name="order.createTime" format="yyyy-MM-dd"/></td>
						<td>下 单 人:</td>
					...
					<tr>
						...
						<td>订单状态:</td>
						<td class="order_show_msg"><e:orderStatetext orderType="${order.orderType }" orderState="${order.orderState }"/></td>
						<td>商品总量:</td>
