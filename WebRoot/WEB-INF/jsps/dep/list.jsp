	...
	<div class="content-text">
		<form action="${path }/dep_list" method="post">
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="70"><a id="addDepButton" href="#"><img
			...
			<div class="square-order">
				<center>
					<span style="font-size:20px;color:#96D34A;font-weight:bold;display: none;">没有查找到满足条件的数据！</span>
				</center>
						...
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td>
								...
								<span style="line-height:12px; text-align:center;"> 
									<a href="#" class="xiu" onclick="updateDep(<s:property value="#dep.depId"/>)">修改</a>
								</span> 
								<img src="${path }/images/icon_04.gif" /> 
								<span style="line-height:12px; text-align:center;"> 
									<a href="#" class="xiu" onclick="deleteDep(<s:property value="#dep.depId"/>)">删除</a>
								</span>
							</td>
						</tr>
					</s:iterator>
