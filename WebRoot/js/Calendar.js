...
str += '<div Author="alin" class="cdrWatermark" id="cdrWatermark"></div><div id="cdrBody" style="position:absolute;left:0px;:0px;z-index:2;width:140px;">';
str += this.getHeader();
str += this.getBody();   
...
//控制位置	
{	  
_obj.style.top = (_target.y - _obj.clientHeight + 201) + 'px';
}
};
